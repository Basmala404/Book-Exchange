...
INSERT INTO `books` (`id`, `user_id`, `title`, `author`, `genre`, `description`, `condition`, `availability`, `created_at`) VALUES
(1, 1, 'To Kill a Mockingbird', 'Harper Lee', 'Classic', 'A timeless novel about justice and race.', 'Good', 1, '2025-08-16 18:10:15'),
(2, 2, 'The Great Gatsby', 'F. Scott Fitzgerald', 'Classic', 'A story of the Jazz Age and the American Dream.', 'Like New', 1, '2025-08-16 18:10:15'),
(3, 2, 'The Catcher in the Rye', 'J.D. Salinger', 'Classic', 'A coming-of-age novel.', 'Fair', 1, '2025-08-16 18:10:15'),
(4, 4, 'Harry Potter and the Philosopher\'s Stone', 'J.K. Rowling', 'Fantasy', 'The first Harry Potter book.', 'Like New', 1, '2025-08-16 18:10:15'),
(5, 5, '1984', 'George Orwell', 'Dystopian', 'A chilling depiction of totalitarianism.', 'Good', 1, '2025-08-16 18:10:15'),
(6, 6, 'The Hobbit', 'J.R.R. Tolkien', 'Fantasy', 'Bilbo\'s adventure through Middle-earth.', 'Like New', 1, '2025-08-16 18:10:15'),
(7, 7, 'Pride and Prejudice', 'Jane Austen', 'Romance', 'A love story with social commentary.', 'Fair', 1, '2025-08-16 18:10:15'),
(8, 8, 'The Da Vinci Code', 'Dan Brown', 'Thriller', 'A fast-paced mystery thriller.', 'Good', 1, '2025-08-16 18:10:15'),
(9, 9, 'The Alchemist', 'Paulo Coelho', 'Philosophical', 'A novel about dreams and destiny.', 'Like New', 1, '2025-08-16 18:10:15'),
(10, 10, 'Moby-Dick', 'Herman Melville', 'Adventure', 'The quest for the great white whale.', 'Poor', 1, '2025-08-16 18:10:15'),
(11, 1, 'Little Women', 'Louisa May Alcott', 'Classic', 'The story of four sisters.', 'Good', 1, '2025-08-16 18:10:15'),
(12, 3, 'Brave New World', 'Aldous Huxley', 'Dystopian', 'A futuristic world of control.', 'Fair', 1, '2025-08-16 18:10:15'),
(13, 5, 'The Lord of the Rings', 'J.R.R. Tolkien', 'Fantasy', 'Epic high fantasy trilogy.', 'Like New', 1, '2025-08-16 18:10:15'),
(14, 7, 'The Fault in Our Stars', 'John Green', 'Romance', 'A heartbreaking love story.', 'Good', 1, '2025-08-16 18:10:15'),
(15, 9, 'Crime and Punishment', 'Fyodor Dostoevsky', 'Classic', 'A psychological novel about guilt.', 'Good', 1, '2025-08-16 18:10:15');
...
INSERT INTO `exchanges` (`id`, `book_id`, `requester_id`, `status`, `created_at`) VALUES
(1, 1, 2, 'pending', '2025-08-16 18:10:15'),
(2, 2, 1, 'approved', '2025-08-16 18:10:15'),
(3, 4, 3, 'completed', '2025-08-16 18:10:15'),
(4, 5, 6, 'pending', '2025-08-16 18:10:15'),
(5, 7, 8, 'approved', '2025-08-16 18:10:15'),
(6, 9, 10, 'rejected', '2025-08-16 18:10:15'),
(7, 12, 4, 'completed', '2025-08-16 18:10:15'),
(8, 14, 9, 'pending', '2025-08-16 18:10:15');
